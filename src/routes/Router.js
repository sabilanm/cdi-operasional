...
const SpecialAssignmentDetailUser = lazy(() => import("../features/special_assignemnt/ui/DetailUser"));
...
const TargetPelunasanKPIList = lazy(() => import("../features/target_pelunasan_kpi/ui/List"));
...
const FullLayoutRoutes = [
    {
        ...
        children: [
            ...
            { path: "master-kpi/special-assignment/:id/detail/:assignment_detail_id/assignment_detail", element: priv(SpecialAssignmentDetailUser) },
            ...
            { path: "/target-pelunasan", element: priv(TargetPelunasanKPIList) },
            // Internal Wildcard
